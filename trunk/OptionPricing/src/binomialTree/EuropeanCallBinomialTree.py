...
if __name__ == '__main__':
    euroCall = EuropeanCallBinomialTree(S0=100, X=105, r=0.05, sigma=0.01, T=1, no_steps=1)
    print euroCall.getPrice()
    #print euroCall.optionPriceTree
    #print euroCall.stockTree
    #print euroCall.u, euroCall.d